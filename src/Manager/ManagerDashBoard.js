...
function ManagerDashboard() {
  ...
  const handlePageChange = (page) => {
    ...
    if (page.includes("Attendance&Leave") || page === "managerattendance" || page === "managermonthlyattendance"|| page === "dailyattendance" || page === "monthlyattendancereport" || page === "managerattendance" || page === "managerviewleave" || page === "leaveApplication"|| page === "holidays") {
